...
public sealed record CatalogResponse(
    ...
    IReadOnlyList<MetavariantDefinition> Metavariants,
    ...
    IReadOnlyList<KnowledgeSkillSuggestionDefinition> KnowledgeSkillSuggestions,
    IReadOnlyList<LanguageSuggestionDefinition> LanguageSuggestions,
...
public static class CharacterCreationEndpoints
{
    ...
    private static CatalogResponse ToResponse(RulesetCatalog catalog) => new(
        ...
        catalog.Metatypes.Values.OrderBy(item => item.Id, StringComparer.Ordinal).ToArray(),
         catalog.Metavariants.Values.OrderBy(item => item.Id, StringComparer.Ordinal).ToArray(),
         ...
         catalog.KnowledgeSkillSuggestions.Values.OrderBy(item => item.DisplayName, StringComparer.Ordinal).ToArray(),
         catalog.LanguageSuggestions.Values.OrderBy(item => item.DisplayName, StringComparer.Ordinal).ToArray(),
