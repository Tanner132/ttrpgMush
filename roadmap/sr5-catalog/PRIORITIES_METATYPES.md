...
| `mystic-adept-power-points` | Mystic Adept Power Points | `bookkeeping` | No free Power Points; buy whole points for 5 Karma each (published errata; `sr5-core` prints 2 Karma), up to current Magic. Decision: `mystic-adept.power-points`, `mystic-adept.power-point-cost-errata`. | `sr5-core` pp. 69, 71, 101 (PDF 71, 73, 103) |
