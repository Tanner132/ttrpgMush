...
| `mystic-adept` | Mystic Adept | `selectable` | Same A/B/C Magic, skill, and formula grants as magician. May use all three magical groups; cannot astrally project; astral perception requires its adept power. No free PP: may buy whole PP for 2 Karma each, maximum PP equal to Magic. Tradition required. | `sr5-core` pp. 65, 69, 71, 101 (PDF 67, 71, 73, 103); `run-faster` p. 63 (PDF 65). Decision: `mystic-adept.power-points` |
